                ...
                <Modal
                    ...
                    <Modal.Body>
                            ...
                            <div className="steps-action">
                                <Button className="ml8" colors="primary" onClick={this.alertDone}> <Icon type="uf-save" />保存</Button>
                                <Button className="ml8" colors="primary" onClick={this.close}> <Icon type="uf-filterno" />取消</Button>
                            </div>
                    </Modal.Body>
