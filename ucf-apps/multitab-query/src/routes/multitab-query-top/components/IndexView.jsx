...
import {Form,Tabs } from 'tinper-bee';
...
import LeaseQuoteIndexView from './LeaseQuoteIndexView'
const { TabPane } = Tabs;
...
class IndexView extends Component {
    ...
    lease_times:'12', plan_date:'12', trans_type:0,lease_cash_corpus:'10200', lease_cash_tax:600,lease_cash:10000};
        return (            
            ...
            <div className="multitab-top-form">
                <div className='top-form-body'>
                <Tabs
                    defaultActiveKey="1"
                ...
                >
                    <TabPane tab='合同制作' key="1">
                        <div>
                            <ContractFormView formObject = {ContractFormObj}></ContractFormView>
                        </div>
                    </TabPane>
                    <TabPane tab='报价方案' key="2">
                        <div>
                            <LeaseQuoteIndexView quoteList ={this.props.quoteList} quoteFormObj = {this.props.quoteFormObj} pkContract = {'1'} />
                        </div>
                    </TabPane>
                    <TabPane tab='承租方信息' key="3">承租方信息</TabPane>
                    <TabPane tab='供应商信息' key="4">供应商信息</TabPane>
                    <TabPane tab='租赁物件' key="5">租赁物件</TabPane>
                </Tabs>
                </div>
            </div>
