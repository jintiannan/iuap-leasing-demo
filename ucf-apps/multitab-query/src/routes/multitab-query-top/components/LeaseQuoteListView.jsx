...
class LeaseQuoteListView extends Component {
    ...
    componentDidMount() {
        //查询后台数据
        actions.multitop.loadQuoteList({param:this.props.pkContract});
        //绑定父组件
    ...
    freshData = (pageIndex) => {
        ...
        actions.multitop.loadList(queryParam);
    }
    ...
    getSelectedDataFunc = (selectedList, record, index) => {
        ...
        actions.multitop.updateState({quoteFormObj: _formObj,quoteList:_list});

    }

    childList = (obj) => {
        //加载子组件列表
        actions.multitop.loadChildList(this.props.queryParam);
    }
