...
class ButtonGroup extends Component {
    ...
    render() {
        ...
        return (
            ...
            */}
                <Button visible={_props.isGrid} className="ml8" colors="primary" onClick={_props.View}><Icon type='uf-search'/>查看</Button>
                <Button visible={!_props.isGrid}  className="ml8" colors="primary" onClick={_props.Return}><Icon type='uf-search'/>返回</Button>
                <Button className="ml8 yl-r-b" colors="primary" onClick={_props.View}><Icon type='uf-files-o'/>关联报价</Button>
                <Button className="ml8 yl-r-b" colors="primary" onClick={_props.View}><Icon type='uf-files-o'/>取消关联</Button>
                <Button className="ml8 yl-r-b" colors="primary" onClick={_props.View}><Icon type='uf-files-o'/>财务审核修改</Button>
            </div>
